...
HOLIDAYS = [
    ...
    "2026-03-27", "2026-04-01", "2026-04-04", "2026-04-14", 
...
target_funds = [
    ...
    "Nippon India Nivesh Lakshya Long Term Fund- Direct Plan- Growth Option",
...
def main():
    ...
    if today.weekday() in [0, 7] or today.strftime('%Y-%m-%d') in HOLIDAYS:
